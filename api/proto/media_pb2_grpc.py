...
class MediaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessFile = channel.unary_unary(
                ...
                request_serializer=media__pb2.FileRequest.SerializeToString,
                response_deserializer=media__pb2.FileResponse.FromString,
...
def add_MediaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessFile': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=media__pb2.FileRequest.FromString,
                    response_serializer=media__pb2.FileResponse.SerializeToString,
            ),
    }
...
class MediaService(object):
    ...
    def ProcessFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/media.MediaService/ProcessFile',
            media__pb2.FileRequest.SerializeToString,
            media__pb2.FileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
